...
After you configure the connection between the server and the command line tool, you can use the command line interface to connect to the Quipucords server. After you are logged in, you can begin using Quipucords to set up and run scans on your IT infrastructure.
