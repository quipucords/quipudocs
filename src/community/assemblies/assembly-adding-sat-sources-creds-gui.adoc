...
* To add a satellite source, see xref:proc-adding-sat-sources-gui-{context}[Adding satellite sources].
* To add a satellite credential, see xref:proc-adding-sat-creds-gui-{context}[Adding satellite credentials].
...
* xref:con-sat-auth-gui-{context}[Satellite Server authentication]
