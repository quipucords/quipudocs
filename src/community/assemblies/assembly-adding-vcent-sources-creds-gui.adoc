...
* To add a vcenter source, see xref:proc-adding-vcent-sources-gui-{context}[Adding vcenter sources].
* To add a vcenter credential, see xref:proc-adding-vcent-creds-gui-{context}[Adding vcenter credentials].
...
* xref:con-vcent-auth-gui-{context}[vCenter Server authentication]
