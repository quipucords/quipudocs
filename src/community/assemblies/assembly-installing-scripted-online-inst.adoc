...
The online, or automated, installation process runs an installer that uses Ansible to install the command line tool, the server image, and the database image.
